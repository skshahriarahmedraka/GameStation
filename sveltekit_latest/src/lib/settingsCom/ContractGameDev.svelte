...
<div class="flex flex-col p-4 transition-all duration-200  ease-linear">
	<div class=" flex flex-col items-center">
		<p class=" m-3 font-Poppins text-2xl text-slate-200">Contract Game Developer :</p>
		<div class=" flex h-56 w-[80%] flex-col rounded-lg border-2 border-slate-200">
			<div class="flex flex-row">
				<p class="m-6 font-Poppins text-base text-slate-200">Give your feedback to Developer </p>
