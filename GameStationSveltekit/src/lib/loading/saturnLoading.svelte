...
<!-- about -->
<!-- <div class="about h-screen w-full flex justify-center items-center ?">
...
<!-- end about -->
<!-- bg-[#3c4359]  -->
<div class=" {$$props.class} flex min-h-screen max-h-screen w-screen items-center justify-center  bg-[#121212]  ">
	<div class="content ">
		<div class="planet">
			<div class="ring" />
