...
//     Moto:string 
// }[]
export let CarouselList:GameDataType[] = [] as GameDataType[]
...
<div class="carousel aspect-[16/9] h-[600px] bg-[#252525] flex flex-col">
    <!-- content here -->
        ...
        <div class=" grow"></div>
        <div class=" h-16 w-28 m-5 bg-slate-400 rounded-xl opacity-30 justify-center"></div>
